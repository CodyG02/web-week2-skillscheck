...
let faveColors = ['orange','purple','red']
...
let me = {
    firstName:'cody',
    superHeroName: 'never worried about the sun man',
    homeTown: 'sandy',
    superPowers: ['create a pair of sunglasses','any style','any color'],
