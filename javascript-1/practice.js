...
function bigOrSmall(arr){
	...
	for(let i = 0; i < arr.length; i++){
		...
		} else return answers.push(arr[i] ='small')
	}
}
...
let total = myNumbers.reduce((a, e) => {
	return a + e
}, 0)
...
// let myNumbersIndex = myNumbers.forEach(e => myNumbers.findindex(e => myNumbersIndex.push([e])))
...
let totallyAwesome = people.reduce((a,e) =>{
